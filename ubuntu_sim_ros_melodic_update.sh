...
sudo apt-get install libgeographiclib-dev -y
sudo geographiclib-get-geoids egm96-5 -y
...
sudo apt-get install gstreamer1.0-doc gstreamer1.0-tools gstreamer1.0-x gstreamer1.0-alsa -y gstreamer1.0-gl gstreamer1.0-gtk3 gstreamer1.0-qt5 gstreamer1.0-pulseaudio -y
